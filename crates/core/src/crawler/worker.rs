...
impl<S: DatumSink> JobExecutor<S> {
    pub fn new(
        ...
        Self {
            ...
            min_crawl_delay: Duration::from_millis(config.ingestion.politeness.gap_ms),
            max_crawl_delay: Duration::from_secs(super::politeness::MAX_ACCEPTED_CRAWL_DELAY_SECS),
            max_url_slowdown_retry: config.ingestion.politeness.retry_budget,
            max_politeness_factor: 0,
